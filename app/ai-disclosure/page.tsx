...
export const metadata: Metadata = {
  ...
  description: "How CastingCompass uses automated models and AI review.",
};
  ...
  return (
    ...
    >
      ...
      <LegalSection title="Trip-note and gear review">
        <p>When a signed-in angler completes or edits a trip report, Xiaomi MiMo may review a limited trip payload. It normalizes recognizable rod, reel, lure, and rig names; flags inconsistent or unsafe content; and creates a possible anonymous summary for the selected location’s discussion page. The public summary is intended to remove names, contact information, exact sensitive location clues, and unrelated material.</p>
