...
all 242 direct `.prepare()` sites: 228 literal statements and 14 separately reviewed nonliteral
...
database, runs 37 representative `EXPLAIN QUERY PLAN` checks, and rejects missing leftmost
