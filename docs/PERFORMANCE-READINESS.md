...
all 241 direct `.prepare()` sites: 227 literal statements and 14 separately reviewed nonliteral
...
database, runs 36 representative `EXPLAIN QUERY PLAN` checks, and rejects missing leftmost
