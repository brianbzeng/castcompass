...
all 243 direct `.prepare()` sites: 229 literal statements and 14 separately reviewed nonliteral
...
database, runs 38 representative `EXPLAIN QUERY PLAN` checks, and rejects missing leftmost
