...
const sourcePaths = [
  ...
  ["field-review/marin-structure-depth-review-policy.json", "field-review/marin-structure-depth-review-policy.json"],
  ["field-review/north-east-bay-structure-depth-review-policy.json", "field-review/north-east-bay-structure-depth-review-policy.json"],
...
export function verifyReleaseArtifacts({ outputDirectory, commitSha, repository }) {
  ...
  const requiredEntries = [
    ...
    `${RELEASE_PREFIX}/field-review/marin-structure-depth-review-policy.json`,
    `${RELEASE_PREFIX}/field-review/north-east-bay-structure-depth-review-policy.json`,
